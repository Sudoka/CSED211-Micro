...
void Lcd_Init(int type)
{
	...
	rLCDSADDR2=M5D( ((U32)frameBuffer8BitTft240320+(LCD_XSIZE_TFT_240320*LCD_YSIZE_TFT_240320/1))>>1 );
	rLCDSADDR3=0;//(((SCR_XSIZE_TFT_240320-LCD_XSIZE_TFT_240320)/2)<<11)|(LCD_XSIZE_TFT_240320/2);
